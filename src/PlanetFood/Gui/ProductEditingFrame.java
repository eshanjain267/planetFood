...
HashMap<String,Product> pm ;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 40, -1, 50));
        ...
        btnSaveChanges.setFont(new java.awt.Font("Tahoma", 1, 26)); // NOI18N
        ...
        jPanel3.add(btnSaveChanges, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 530, 290, 50));
        ...
        jPanel3.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 530, 230, 50));
        ...
        txtProdPrice.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 10));
        ...
        CBIsActive.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        CBIsActive.setForeground(new java.awt.Color(255, 255, 255));
        CBIsActive.setSelected(true);
        CBIsActive.setText(" IS ACTIVE");
        jPanel3.add(CBIsActive, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 470, -1, -1));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 110, 810, 610));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/food1.gif"))); // NOI18N
        jLabel6.setText("jLabel6");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 400, 240));
...
try{
       ...
       pd.setIsActive("Y");
           ...
           pd.setIsActive("N");
       pd.setProId(txtProductId.getSelectedItem().toString());
       ...
       if(ProductDao.UpdateProduct(pd)){
        JOptionPane.showMessageDialog(null,"Succesfully Updation to DB","SUCCESS",JOptionPane.INFORMATION_MESSAGE);
     
       }
        else
      JOptionPane.showMessageDialog(null,"UNSuccesfull Updation to DB","Failure!!",JOptionPane.ERROR_MESSAGE);
...
try{
    ...
    txtProdPrice.setValue(pd.getProdPrice());
 
    if(pd.getIsActive().equals("Y"))
        CBIsActive.setSelected(true);
     else
