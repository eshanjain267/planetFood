 ...
 * @author HP
 */
public class EditEmpDetailsFrame extends javax.swing.JFrame {

    /**
     * Creates new form EditEmpDetailsFrame
     */
    public EditEmpDetailsFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, 520, 50));
        ...
        btnUpdateEmployee.setFont(new java.awt.Font("Tahoma", 1, 22)); // NOI18N
        ...
        jPanel1.add(btnUpdateEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 700, 280, 50));
        ...
        jPanel2.add(txtempId, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, 290, -1));
        ...
        jPanel2.add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 100, 190, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, 800, 470));

        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\user logo.jpg")); // NOI18N
        jLabel6.setText("jLabel6");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 200, 220));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 700, 260, 50));
    ...
    private void btnUpdateEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateEmployeeActionPerformed
      if(validateInput()==false)
        {
            JOptionPane.showMessageDialog(null,"Please Make sure that all fileds are filled with correct details","Empty Values",JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int ans;
        ans=JOptionPane.showConfirmDialog(null, "Are u sure ?","Back!",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
...
try{
 ...
 txtJob.setSelectedItem(e.getJob().toUpperCase());
}
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditEmpDetailsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditEmpDetailsFrame().setVisible(true);
            }
        });
