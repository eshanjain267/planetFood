...
HashMap<String,Product> pm ;
 Set al ;
    ...
    public ViewMenuListFrame() {
        ...
        model.setRowCount(0);
        try{
          ProdList.setRowHeight(32);
          
        ProdLis = ProductDao.getAllProduct();
        for(Product Pd:ProdLis){
            Object[] row = {Pd.getProId(),Pd.getCatId(),Pd.getProdName(),Pd.getProdPrice(),Pd.getIsActive()};
          if(hm.get(txtcategories.getSelectedItem().toString()).toString().equals(Pd.getCatId()))
            model.addRow(row);
        }
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Menu List Panel");
        ...
        jPanel3.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 550, 320, 50));

        ProdList.setBackground(new java.awt.Color(0, 102, 102));
        ProdList.setFont(new java.awt.Font("Tahoma", 1, 22)); // NOI18N
        ProdList.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ProdList.setRowSelectionAllowed(false);
        jScrollPane1.setViewportView(ProdList);

        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 830, 390));
        ...
        jPanel3.add(txtcategories, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 820, 40));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, 870, 610));
